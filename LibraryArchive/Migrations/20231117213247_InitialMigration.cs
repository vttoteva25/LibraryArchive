...
namespace LibraryArchive.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BirthDate", "Discriminator", "Email", "FirstName", "LastName", "Password", "PhoneNumber", "RoleId", "Username" },
                values: new object[] { 1, new DateTime(2003, 4, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Librarian", "viktoriya.toteva@abv.bg", "Виктория", "Тотева", " ,?b?Y[?K-#Kp", "0885904536", 1, "vttoteva" });
